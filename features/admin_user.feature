...
Feature: CRUD operation on User
	...
	# 	And I select user_role_id with value 1 and I press "Criar/Atualizar"
	# 	Then I should be redirected to users page and I should see "Usuário criado com sucesso!"

	Scenario: Should be able to update a existing user
		Given I am on the users page
		When I clicked on "Edit" link of a specific user
		And I fill in password with "123"
		And I fill in password_confirmation with "123"
		And I fill in "first_name" with "Junedune" and I press "Criar/Atualizar"
		Then I should be redirected to users show page and I should see "Usuário atualizado com sucesso!"